...
# --- 6. Main program (adapted for Qwen2.5-VL-7B) ---
model_dir = snapshot_download("Qwen/Qwen2.5-VL-7B-Instruct", revision="master")
...
args = Seq2SeqTrainingArguments(
    output_dir=r"D:\ZhengHe_CKMData\archive\Qwen2.5-VL-7B-chengkuang-3tasks",
...
swanlab_callback = SwanLabCallback(
    ...
    experiment_name="Qwen2.5-VL-7B-chengkuang",
    config={
        "dataset": "json_file",
        "source": "dataset.json",
        "metrics": "ROUGE/BLEU",
